...
app.post('/quiz/submit', async (req, res) => {
    ...
    try {
        ...
        // Fetch correct answers + explanations from DB
        ...
        const detailedResults = answers.map(({ questionId, selectedOption }) => {
            ...
            if (isCorrect) score += 10;  // updated: 10 marks per correct
        ...
        // Insert quiz_attempts and get attempt_id
        ...
        const attemptId = attemptInsert.rows[0].attempt_id;  // ⚠️ FIX: use attempt_id, not .id
